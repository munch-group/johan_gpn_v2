...
On autosomes, A/B compartments follow a well-established pattern: A compartments are GC-rich, gene-dense, and transcriptionally active, while B compartments are AT-rich, gene-poor, and heterochromatic (Lieberman-Aiden et al. 2009). Multiple studies have confirmed this relationship, with correlations between compartment identity and GC content often exceeding r = 0.8. Surprisingly, however, this principle has never been quantitatively assessed for the X chromosome, despite extensive work on its compartmental organization.
...
The dataset used in this study was generated from Macaca (rhesus macaque) samples, covering five distinct stages of spermatogenesis, as well as fibroblasts for comparison. These stages represent the continuum of male germ cell development from undifferentiated precursors to mature gametes.

Spermatogonia are the mitotically active stem and progenitor cells located at the basal layer of the seminiferous tubules. They serve as the foundation of spermatogenesis by both self-renewing to maintain the stem cell pool and differentiating to give rise to spermatocytes. This stage is characterized by robust proliferative activity and the initiation of gene expression programs that prepare cells for meiosis.

Pachytene spermatocytes are primary spermatocytes in the prolonged pachytene stage of meiotic prophase I. During this phase, homologous chromosomes are fully synapsed and undergo genetic recombination through crossing-over, ensuring genetic diversity in gametes. These cells also exhibit high levels of transcriptional activity, producing RNAs that will be used later during spermatid development, as transcription becomes reduced after meiosis.

Following meiosis II, round spermatids are formed as haploid germ cells. At this point, the cells no longer divide but instead undergo extensive remodeling during spermiogenesis. Chromatin begins to compact, transcriptional activity decreases, and transcripts stored earlier are translated to support structural changes. Morphologically, the cells remain spherical at this stage.

Through spermiogenesis, round spermatids differentiate into elongated spermatids and ultimately mature spermatozoa. This process involves dramatic nuclear condensation, replacement of histones with protamines, formation of the acrosome, and development of the flagellum for motility. Mature sperm are transcriptionally silent and highly specialized for fertilization.

Finally, fibroblasts, isolated from connective tissue, were included as a non-germline somatic control. Unlike germ cells, fibroblasts are not involved in reproduction but maintain structural and extracellular matrix functions. Their inclusion allows for distinguishing germline-specific molecular signatures from general cellular processes.

Together, these samples provide a comprehensive view of germ cell differentiation across spermatogenesis, with fibroblasts serving as a reference point for somatic baseline comparisons.
...
::: {#fig-CPG_islands_overlay}
![](illustrations/cpgislands/cpgislands_chr8_plus_chrx_overlay_grid3x2_allaxes_newdata.png){width=100%}

**Figure:** cpgislands 
:::


::: {#fig-simple_repeat_combined}
 ![](illustrations/simple_repeat/simple_repeat_chr8_plus_chrx_overlay_grid3x2_allaxes.png){width="100%"} 

**Figure:** simple_repeat repeat
:::


::: {#fig-nested_repeat_combined }
 ![](illustrations/nested_repeat/nested_repeat_chr8_plus_chrx_overlay_grid3x2_allaxes.png){width="100%"} 

**Figure:** nested repeat
:::
