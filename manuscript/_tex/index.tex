...
presence of widespread transcriptional activity (\textbf{wang2019?}).
...
for homologous recombination and transcriptional control
(\textbf{wang2019?}).
...
promoting compartmentalization (\textbf{wang2019?}).
...
to reproductive health (\textbf{wang2019?}).
...
accessibility assays {[}Lieberman-Aiden et al. (2009){]}(Bonev and
Cavalli 2016).
